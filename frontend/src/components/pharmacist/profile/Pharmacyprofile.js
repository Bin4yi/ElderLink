...
const ProfilePage = () => {
  ...
  const navigationItems = [
    { name: 'Dashboard', icon: Home, path: '/pharmacist/dashboard', active: false },
    { name: 'Medications', icon: Package, path: '/pharmacist/medications', active: false },
    { name: 'Prescriptions', icon: FileText, path: '/pharmacist/prescriptions', active: false },
    { name: 'Delivery', icon: Truck, path: '/pharmacist/delivery', active: false },
    { name: 'Inventory', icon: Package, path: '/pharmacist/inventory', active: false },
    { name: 'Profile', icon: User, path: '/pharmacist/profile', active: true }
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col">
        ...
        <div className="flex items-center space-x-3 p-6 border-b border-gray-200">
          ...
          <span className="text-xl font-bold text-gray-900">ElderLink</span>
        </div>
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium text-gray-900">Dr. Kevin Lee</p>
        ...
        <nav className="flex-1 p-4">
          <div className="space-y-1">
            {navigationItems.map((item) => (
              ...
              >
                <item.icon className={`w-5 h-5 ${item.active ? 'text-red-600' : 'text-gray-400'}`} />
                <span>{item.name}</span>
              </a>
            ))}
          </div>
