  ...
  return (
    <RoleLayout>
      <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        {/* Header Card */}
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-2xl p-8 text-white shadow-2xl transform transition-all duration-300 hover:shadow-3xl">
